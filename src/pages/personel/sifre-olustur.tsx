        ...
        <Card className="w-full max-w-lg p-7 md:p-9 shadow-2xl border-slate-200">
          ...
          {checking ? <div className="py-12 text-center text-slate-500">Davet bağlantısı doğrulanıyor...</div> : !ready ? (
            ...
            <form className="space-y-5 mt-7" onSubmit={submit}>
              ...
              <div className="rounded-xl bg-slate-50 border p-4 text-sm text-slate-600 space-y-1"><p className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-600" />En az 6 karakter</p><p className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-600" />Büyük harf, küçük harf ve rakam</p><p className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-600" />Başka hesaplarda kullanmadığınız bir şifre</p></div>
