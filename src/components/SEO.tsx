...
export function SEO({
  ...
  const keywordContent = Array.isArray(keywords)
    ? keywords.join(", ")
    : keywords || "rex lojistik, lojistik firması, kargo şirketi, nakliye, taşımacılık, depolama, dağıtım, hava kargo, deniz kargo, kara taşımacılığı, uluslararası kargo, lojistik çözümleri";
  const absoluteImage = image.startsWith("http")
    ? image
    : `https://www.rexlojistik.com${image.startsWith("/") ? image : `/${image}`}`;
