...
const eventLabels: Record<string, string> = {
  ...
  kolaybi_sync_started: "E-belge aktarımı başlatıldı",
  kolaybi_sync_succeeded: "E-belge aktarımı tamamlandı",
  kolaybi_sync_failed: "E-belge aktarımı tamamlanamadı",
  ...
  invoice_draft_created: "Fatura taslağı oluşturuldu",
  invoice_draft_updated: "Fatura taslağı düzenlendi",
  invoice_accounting_approved: "Fatura taslağı muhasebe tarafından onaylandı",
  invoice_queued: "Fatura e-belge kuyruğuna alındı",
  invoice_submitted: "Fatura e-belge sistemine gönderildi",
  invoice_official: "Resmî e-belge oluşturuldu",
  invoice_retry_scheduled: "Fatura gönderimi yeniden denenecek",
  invoice_status_checked: "E-belge durumu sorgulandı",
...
const fieldLabels: Record<string, string> = {
  ...
  kolaybi_document_id: "E-belge numarası",
  integration_status: "Fatura entegrasyon durumu",
  provider_status: "Resmî belge durumu",
